...
public abstract class AbstractQoSModule extends org.opendaylight.controller.config.spi.AbstractModule<AbstractQoSModule> implements org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.qos.impl.rev141210.QoSModuleMXBean {
    private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.qos.impl.rev141210.AbstractQoSModule.class);
    ...
    public AbstractQoSModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver) {
        super(identifier, dependencyResolver);
    }

    public AbstractQoSModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver,AbstractQoSModule oldModule,java.lang.AutoCloseable oldInstance) {
    ...
    public boolean canReuseInstance(AbstractQoSModule oldModule){
    ...
    public boolean isSame(AbstractQoSModule other) {
        if (other == null) {
    ...
    if (o == null || getClass() != o.getClass()) { return false; }
        AbstractQoSModule that = (AbstractQoSModule) o;
